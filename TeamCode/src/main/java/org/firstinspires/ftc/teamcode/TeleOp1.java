        ...
        while (opModeIsActive()){
            ...
            if(gamepad1.right_stick_y<0) {
                ...
                if(!gamepad1.right_bumper) {
                    motor_Elbow.setPower(gamepad1.right_stick_y * -0.5);
                }
                else{
                ...
                if (gamepad1.right_stick_y > 0) {
                    ...
                    motor_Elbow.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
                    motor_Elbow.setPower(0);
                    if((motor_Elbow.getCurrentPosition()<1800)&& !gamepad1.right_bumper) {
                        motor_Elbow.setPower(gamepad1.right_stick_y * -0.1);
                    }
                    else {
                        motor_Elbow.setPower(gamepad1.right_stick_y * -1);
                    }
            ...
            if(gamepad1.right_stick_x<-0) {
                ...
                motor_Extend.setPower(gamepad1.right_stick_x*-0.5);
            ...
            if(((Math.abs(elbowRequest-motor_Elbow.getCurrentPosition())>armExtensionsTol))&&(Math.abs(gamepad1.right_stick_y)<0.1)&&armPosnCtrl){
                motor_Elbow.setPower(0);
            ...
            if(((Math.abs(extendRequest-motor_Extend.getCurrentPosition())>armExtensionsTol))&&(Math.abs(gamepad1.right_stick_x)<0.1)&&extendPosnCtrl){
